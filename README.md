...
Игровая система пока не закреплена. Сначала создается полная энциклопедия мира, а затем мир можно будет адаптировать под выбранную систему.

Правила работы с проектом: [[📘 Правила работы с проектом]]
